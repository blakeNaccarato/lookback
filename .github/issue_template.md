...
- [ ] I searched [here](https://github.com/blakeNaccarato/lookback/issues?q=label%3Abug+sort%3Acomments-desc) or [here](https://github.com/search?q=repo%3AblakeNaccarato/lookback+label%3Abug&type=issues) and couldn't find a similar issue.

### Please confirm that this bug affects the latest version

<!-- Please verify the issue is present in the latest version by installing it with `pip install lookback==0.0.0` and checking that the bug is still there #} -->

- [ ] This bug affects version `0.0.0` of `lookback`.
